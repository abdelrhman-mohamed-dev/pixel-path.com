      ...
      <div className="z-10">
        <div className="space-y-8 md:text-center">
          ...
          <p className="regular-paragraph mx-auto max-w-[835px]">
            Hi 👋, We &apos;re{" "}
            <span className="text-code text-yellow-600">Pixel Path</span>, a
            passionate software company with a knack for creating scalable,
            ...
            <span className="text-blue-600"> backend technologies</span>, We
